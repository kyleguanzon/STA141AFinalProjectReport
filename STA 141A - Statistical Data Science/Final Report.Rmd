...
Upon data exploration, we know that the data structure of the project is complex since it has plenty of variables/features. We can also assume that there are some interactions among those interactions, and the training set is also relatively large. To avoid overfitting, xgboost is used to create the prediction model. 
